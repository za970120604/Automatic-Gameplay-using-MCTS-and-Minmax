...
def battle(teamID, node_num, seed):
    ...
    :return:
    '''
    global player1_wins , player1_timeout , player2_timeout
...
if __name__ == "__main__":
    ...
    for i in range(episode):
        time.sleep(3)
        main()
        print(f"~~ Player 1 Winning Rate : {player1_wins} / {i+1} ~~")
        print(f"~~ Player 1 Timeout Rate : {player1_timeout} / {i+1} ~~")
        print(f"~~ Player 2 Timeout Rate : {player2_timeout} / {i+1} ~~")
    os.system('pause')
